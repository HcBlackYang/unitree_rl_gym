...
from legged_gym.envs.kitchen.kitchen_env import G1KitchenRobot
from legged_gym.envs.kitchen.kitchen_config import G1KitchenRoughCfg, G1KitchenRoughCfgPPO
...
task_registry.register("g1_kitchen", G1KitchenRobot, G1KitchenRoughCfg(), G1KitchenRoughCfgPPO())